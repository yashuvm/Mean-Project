...
(function () {
    ...
    var baseController = function ($scope,$rootScope,$window,$location,$http,LocalStorageService,baseService) {
       ...
       //  $scope.tokendata = function () {
       //      var headers = { 'authorization': "Bearear " + $rootScope.token };
       //      baseService.tokendata(headers.authorization).success(function (result) {
       //          if(result){
       //
       //          }
       //      })
       //      }
        ...
        $scope.getmoduledata = function(){
                ...
                $scope.moduldatainformationdata = LocalStorageService.get('module1');
            if($scope.moduldatainformationdata == null){
                $scope.moduldatainformation = 1 ;
            }
            else{
