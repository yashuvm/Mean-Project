...
(function () {
  ...
  var injectParams = ['$scope','$rootScope','$location','$filter','editCareManagerService'];
  var editCareManagerController = function ($scope,$rootScope,$location,$filter,editCareManagerService) {
    ...
    $scope.careManagerIdData = function(){
      ...
      $scope.updateCare=function(crm_id){
        ...
        $scope.crm_id=crm_id;
        $scope.crm_mob=$scope.moNumber;
        $scope.crm_alt_mob_no=$scope.altNum;
