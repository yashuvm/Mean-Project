...
(function () {
  ...
  var editRegionManagerController = function ($scope,$rootScope,$location,$filter,editRegionManagerService) {
        ...
        $scope.regionValue1 = element;
          if( $scope.regionId == $scope.regionValue1.rm_id){
            ...
            if( $scope.regionvalue1){
              ...
              $scope.moNumber=$scope.regionvalue1.rm_mob.slice(2,12);
              $scope.altNum=$scope.regionvalue1.rm_alt_mob_no.slice(2,12);
    ...
    $scope.updateRegionManager=function(rm_id){
      ...
      $scope.rm_id=rm_id;
      $scope.rm_mob= "91"+$scope.moNumber;
      $scope.rm_alt_mob_no="91"+$scope.altNum;
     ...
     /*   if(value == false){
      ...
      if($scope.otherpreferd){
        $scope.rm_language =$scope.otherpreferd
      }
