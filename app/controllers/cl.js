...
(function () {
  ...
  var injectParams = ['$scope','$rootScope','$location','$filter','editclusterManagerService'];
  var clController = function ($scope,$rootScope,$location,$filter,editclusterManagerService) {
      ...
      angular.forEach($scope.value1, function (element) {
        ...
        if($scope.clustorId == $scope.clusterValue.clm_id){
          ...
          if($scope.clustervalue2 )
          {
            ...
            $scope.moNum=$scope.clustervalue2.clm_mob.slice(2,12);
            $scope.altNum=$scope.clustervalue2.clm_alt_mob_no.slice(2,12)
            ...
            $scope.dateofbirth=$scope.clustervalue2.clm_dob;
            ...
            if($scope.lang == null){
              ...
              if($scope.language1=="Hindi"){
               ...
               if(($scope.lang !="Hindi")&&($scope.lang !="English")&&($scope.lang != "English,Hindi")&&($scope.lang !="Hindi,English")){
                $scope.preferedlang = {Hindi:false,English:false };
    ...
    $scope.updateClusterManager=function(clm_id){
      ...
      $scope.clm_mob=  "91"+$scope.moNum;
      $scope.altmob=$scope.altNum;
      if($scope.altmob==null){
      $scope.clm_alt_mob_no=""
      }
      else{
        $scope.clm_alt_mob_no="91"+$scope.altmob
      }
      ...
      if($scope.otherpreferd){
        $scope.clm_language=$scope.otherpreferd
      }
    ...
    clController.$inject = injectParams;
    angular.module('seniorApp')
      .controller('clController',clController)
  })();