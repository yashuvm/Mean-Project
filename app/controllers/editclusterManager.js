...
(function () {
  ...
  var injectParams = ['$scope','$rootScope','$location','editclusterManagerService','$filter'];
  var editclusterManagerController = function ($scope,$rootScope,$location,editclusterManagerService,$filter) {
