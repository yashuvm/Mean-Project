 ...
 */
(function () {
  var injectParams = ['$scope',  '$rootScope', '$window','$filter', '$location','$http','mainService','LocalStorageService','emergencyCasesService','customerService'];
  var mainController = function ($scope, $rootScope, $window,$filter, $location,  $http, mainService,LocalStorageService,emergencyCasesService,customerService) {
