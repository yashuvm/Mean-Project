...
(function () {
  ...
  var injectParams = ['$scope','$rootScope','$location','editCommunityManagerService'];
  var editCommunityManagerController = function ($scope,$rootScope,$location,editCommunityManagerService) {
