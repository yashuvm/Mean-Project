...
// };
  ...
  $scope.viewdata = function (emg_id) {
    ...
    monitoringService.viewdata(emg_id).success(function (result) {  
      if (result) { 
        ...
        $scope.getRemark($rootScope.viewId); 
      }
  ...
  $scope.addRemark = function () {
    ...
    // $scope.hhmmsstt = $filter('date')(new Date(), 'hh:mm:ss a');
    $scope.datetime = $scope.addRemarkvalue.r_datetime;
    $scope.remark = $scope.addRemarkvalue.remark;
    $scope.r_user = $scope.addRemarkvalue.r_user;
    monitoringService.addRemark($scope.emg_id, $scope.datetime,$scope.remark,$scope.r_user).success(function (result) {  
      if (result == "ok") { 
