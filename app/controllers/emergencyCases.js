    ...
    emergencyCasesService.monitoringdata().success(function (result) {  
      if (result) {
        ...
        angular.forEach($scope.monitoringDetails, function (element) {
         ...
         if($rootScope.monitoringvalue.emg_source == "sensor"){
            $scope.datetimeValue = $rootScope.monitoringvalue.emg_date_time;
         }
        //  $scope.datetime = $rootScope.monitoringvalue.emg_date_time;
          
         $scope.emgDataId = $rootScope.monitoringvalue.emg_id;
