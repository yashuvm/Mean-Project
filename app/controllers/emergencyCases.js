...
//    $scope.valuedate = new Date();
    ...
    emergencyCasesService.assignEmergencyData($scope.cust_id,$scope.emg_msg,$scope.emg_status,$scope.emg_type,$scope.emg_recv_mode,$scope.emg_desc,$scope.emg_location,$scope.resp_start_time,$scope.est_time_reach,$scope.reaching_time,$scope.closing_time,$scope.cust_remark,$scope.cur_resp_stage).success(function (result) {
      if (result) {
...
$scope.responderdata =
 ...
 $scope.assignResponderData = function (){
   ...
   emergencyCasesService.assignResponderData($scope.emg_case_no,$scope.emg_date_time,$scope.cust_name,$scope.cust_id,$scope.emg_location,$scope.cust_mob,$scope.emg_type, $scope.emg_desc,$scope.emg_id,$scope.rsp_id,$scope.res_mob,$scope.emg_msg).success(function (result) {
    if (result) {
