...
(function () {
    ...
    factory.removehomeMap = function (id,cust_id,room_type,room_name) {
        ...
        serviceInput.room_type = room_type;
        serviceInput.room_name = room_name;
      return $http.post("http://13.233.7.113:5000/api/add/room/deletess",serviceInput)
        .success(function (results) {
          return results;
        })
        .error(function (data) {
    ...
    factory.gethomeLogoutMap = function (CustomerIdValue) {
      var serviceInput = {}; 
        ...
        return $http.get("http://13.233.7.113:5000/api/get/room/particular/" + CustomerIdValue ,serviceInput )
          .success(function (results) {
            return results;
          })
          .error(function (data) {
