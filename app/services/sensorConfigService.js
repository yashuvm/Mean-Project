...
(function () {
  ...
  factory.sensordata = function (custIdvalue) {
    ...
    return $http.get("http://13.233.7.113:5000/api/get/sensor_config/" + custIdvalue ,serviceInput)
          .success(function (results) {
            return results;
          })
          .error(function (data) {
...
factory.getSensorConfigData = function () {
  ...
  return $http.get("http://13.233.7.113:5000/api/add/roomss"  ,serviceInput)
        .success(function (results) {
          return results;
        })
        .error(function (data) {
