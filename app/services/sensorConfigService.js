...
(function () {
    ...
    //     });
    // };
    factory.addSensorConfig = function (id,cust_id,sensor_no,alert_msg,alert_type,alert_location) {
      var serviceInput = {};
      serviceInput.id = id;
...
factory.getRoomType = function (roomTypeValue) {
  ...
  return $http.get("http://13.233.7.113:5000/api/get/room/particular/" + roomTypeValue ,serviceInput)
        .success(function (results) {
          return results;
        })
        .error(function (data) {
