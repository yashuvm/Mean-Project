...
(function () {
    ...
    factory.addRegionManagerdata = function (region_name,region_location,region_address,region_phone,rm_id) {
      ...
      return $http.post("http://13.234.179.251:5000/api/add/region",serviceInput)
    ...
    return $http.post("http://13.234.179.251:5000/api/add/cluster",serviceInput)
      .success(function (results) {
        return results;
      })
      .error(function (data) {
  ...
  return $http.post("http://13.234.179.251:5000/api/add/community",serviceInput)
    .success(function (results) {
      return results;
    })
    .error(function (data) {
    ...
    factory.regionManager = function () {
      ...
      factory.getRegionManagerData = function () {
        ...
        return $http.get("http://13.234.179.251:5000/api/get/region")
          .success(function (results) {
            return results;
          })
          .error(function (data) {
      ...
      factory.getAlldata = function () {
        ...
        return $http.get("http://13.234.179.251:5000/api/all")
          .success(function (results) {
            return results;
          })
          .error(function (data) {
