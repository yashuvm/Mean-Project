...
(function () {
  ...
  factory.updateregion = function (region_id,region_name,region_location,region_address,region_phone,rm_id) {
    var serviceInput = {};
    serviceInput.region_name = region_name;
    serviceInput.region_location = region_location;
    serviceInput.region_address = region_address;
  ...
  return $http.put("http://13.233.7.113:5000/api/update/region/"+ region_id,serviceInput)
    .success(function (results) {
      return results;
    })
    .error(function (data) {
...
/* cluster update */
//   factory.updateClusterRegionManager= function (rm_id,region_id) {
//     var serviceInput = {};
//     serviceInput.rm_id=rm_id;

  

//   return $http.put("http://13.233.7.113:5000/api/put/zone/region/"+ region_id,serviceInput)
//     .success(function (results) {
//       return results;
//     })
//     .error(function (data) {
...
factory.updtaeCluster= function (cluster_id,cluster_name,cluster_location,cluster_address,cluster_phone,clm_id,region_id) {
  var serviceInput = {};
...
return $http.put("http://13.233.7.113:5000/api/update/cluster/"+ cluster_id,serviceInput)
  .success(function (results) {
    return results;
  })
  .error(function (data) {
...
factory.updateCommunity= function (comm_id,comm_name,cluster_id,comm_location,comm_address,comm_phone,cm_id) {
var serviceInput = {};
...
return $http.put("http://13.233.7.113:5000/api/update/community/"+ comm_id,serviceInput)
.success(function (results) {
  return results;
})
.error(function (data) {
