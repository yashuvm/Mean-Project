...
(function () {
     ...
     *******************************************************/
      ...
      factory.customerData = function () {
        ...
        return $http.get("http://13.234.179.251:5000/api/emrg/customer_details")
      ...
      return $http.post("http://13.234.179.251:5000/api/emrg/add/customer_details",serviceInput)
        .success(function (results) {
          return results;
        })
        .error(function (data) {
    ...
    factory.assignResponderData = function (emg_case_no,emg_date_time,cust_name,cust_id,emg_location,cust_mob,emg_type,emg_desc,emg_id,rsp_id,res_mob,emg_msg) {
      var serviceInput = {};
    ...
    return $http.post("http://13.234.179.251:5000/api/post/add/responder_emerg",serviceInput)
      .success(function (results) {
        return results;
      })
      .error(function (data) {
    ...
    factory.emergencyDetailsData = function () {
      ...
      return $http.get("http://13.234.179.251:5000/api/get/emrg_details")
        .success(function (results) {
          return results;
        })
        .error(function (data) {
    ...
    factory.assigndatavalue = function (emg_case_no) {
      ...
      return $http.get("http://13.234.179.251:5000/api/get/emrg_assigndetails/" + emg_case_no)
        .success(function (results) {
          return results;
        })
        .error(function (data) {
    ...
    factory.getResponderData = function () {
      ...
      return $http.get("http://13.234.179.251:5000/api/get/responder")
        .success(function (results) {
          return results;
        })
        .error(function (data) {
