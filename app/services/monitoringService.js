...
(function () {
     ...
     *******************************************************/
      ...
      factory.buttonActivation = function (emg,flagvalue) {
        var serviceInput = {};
        serviceInput.emg = emg;
        serviceInput.flagvalue = flagvalue;
        return $http.put("http://13.233.7.113:5000/api/put/flag_motioring/" + emg +"/" + flagvalue,serviceInput)
          .success(function (results) {
            return results;
          })
          .error(function (data) {
      ...
      factory.addRemark = function (emg_id,remark,r_user) {
        ...
        // serviceInput.r_datetime = r_datetime;
