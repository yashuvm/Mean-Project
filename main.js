...
var AppComponent = /** @class */ (function () {
    function AppComponent(_appserive) {
        this._appserive = _appserive;
        this.title = 'ec2';
        this.dis = false;
        this.color = "red";
        this.dis_id = "0";
    ...
    AppComponent.prototype.myFunction = function (value) {
        //console.log(value);
        var _this = this;
        this._appserive.handleapi(value).subscribe(function (res) {
            //  console.log(res);
            var ary = res;
            console.log(ary);
            if (ary.length > 0) {
    ...
    AppComponent.prototype.myFunction1 = function () {
        var _this = this;
        this._appserive.handleapi2().subscribe(function (res) {
            var ids = res;
            _this.dis_id = ids;
            _this.contractTypeValid = "1";
...
var AppService = /** @class */ (function () {
    function AppService(http) {
        ...
        this._url = "http://13.233.216.42:3000/api/post/test_data";
        this._Url = "http://13.233.216.42:3000/api/create/instance";
    }
    AppService.prototype.handleapi = function (value) {
        var obj = {
    ...
    AppService.prototype.handleapi2 = function () {
...
module.exports = __webpack_require__(/*! C:\ec2_project\ec2\src\main.ts */"./src/main.ts");
