...
$.extend(Grid.prototype, {
	...
	//<span class="t_button"> <a href="javascript:void(0)" title="Create Appointment" class="btn btn-success" style="padding: 12px 44px;"><i class="fa fa-clock-o"></i></a> <a href="javascript:void(0)" title="Agenda" class="btn btn-warning" style="padding:12px 44px;"> <i class="fa fa-file-text"></i> </a></span>
...
$.extend(TimeGrid.prototype, {
	...
	slatRowHtml: function() {
		...
		var minutes;
		var axisHtml;
		//var slots = localStorage.getItem('appointmentslots');
		var index = 0;
		//alert(this.minTime);
		...
		while (slotTime < this.maxTime) {
			...
			html +=
				'<tr ' + (!minutes ? '' : 'class="fc-minor"') + '>' +
					(!isRTL ? axisHtml : '') +
					'<td class="' + view.widgetContentClass + '">  <button type="button" class="btn btn-success btn-sm btn-block border_radius_none" location.href="#!/appointments"'+(slots[index].booked ? 'disabled':'')+'>'+slots[index].time+(slots[index].booked ? ' : Booked':' : Available')+'</button></td>' +
					(isRTL ? axisHtml : '') +
				"</tr>";
...
var	Domain = "https://api.healthforu.com";
