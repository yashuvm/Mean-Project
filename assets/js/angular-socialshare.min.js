...
angular.module("djds4rce.angular-socialshare", []).factory("$FB", ["$window", function (t) {
  return {
    init: function (e) {
      ...
      this.fbId = e, t.fbAsyncInit = function () {
        FB.init({appId: e, channelUrl: "app/channel.html", status: !0, xfbml: !0})
      }, function (t) {
        var e, n = "facebook-jssdk", i = t.getElementsByTagName("script")[0];
    ...
    link: function (e, n, i) {
      i.$observe("url", function () {
        i.shares && i.url && t.get("https://api.facebook.com/method/links.getStats?urls=" + i.url + "&format=json").success(function (t) {
          var n = t[0] ? t[0].total_count.toString() : 0, i = "";
          ...
          FB.ui({method: "share", href: i.url}, function (t) {
  ...
  return {
    scope: {callback: "=", shares: "="},
    transclude: !0,
    template: '<div class="facebookButton"><div class="pluginButton"><div class="pluginButtonContainer"><div class="pluginButtonImage"><button type="button"><i class="pluginButtonIcon img sp_plugin-button-2x sx_plugin-button-2x_favblue"></i></button></div><span class="pluginButtonLabel">Share</span></div></div></div>',
    link: function (e, n, i) {
      i.$observe("url", function () {
        i.shares && i.url && t.get("https://api.facebook.com/method/links.getStats?urls=" + i.url + "&format=json").success(function (t) {
          var n = t[0] ? t[0].total_count.toString() : 0, i = "";
    ...
    link: function (e, n, i) {
      var o = debounce(function () {
        i.url && t(function () {
          ...
          }, {count: i.count, text: i.text, via: i.via, size: i.size})
        })
      }, 75);
  ...
  return {
    scope: {shares: "="},
    transclude: !0,
    template: '<div class="linkedinButton"><div class="pluginButton"><div class="pluginButtonContainer"><div class="pluginButtonImage">in</div><span class="pluginButtonLabel"><span>Share</span></span></div></div></div>',
    link: function (i, o, r) {
  ...
  return {
    link: function (t, e, n) {
      var i = debounce(function () {
        ...
        return function () {
          var t = document.createElement("div"), i = n.id || randomString(5);
  ...
  return {
    link: function (t, e, n) {
      var i = document.createElement("a"), o = debounce(function () {
